...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-32 pb-24 relative overflow-hidden font-sans text-slate-900">
      ...
      <div className="max-w-2xl mx-auto px-6 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white border border-slate-200 text-rose-500 mb-6 shadow-sm">
        ...
        {/* Form Container */}
        <div className="bg-white border border-slate-100 p-8 md:p-10 rounded-[32px] shadow-2xl relative overflow-hidden">
          ...
          {success ? (
            <div className="flex flex-col items-center text-center py-10 animate-in zoom-in-95 duration-500">
              ...
              <p className="text-slate-600 mb-8">
                Thank you for applying to Mr & Miss Mavoko. Our team will review your application and contact you with audition details.
              </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-12 pr-4 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-rose-400 transition-colors shadow-sm"
                  />
                </div>
              </div>
              ...
              {/* Location */}
              <div>
                <label className="block text-xs font-bold uppercase tracking-widest text-slate-500 mb-2">Current Location</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="City / Area of residence"
                    className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-12 pr-4 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-rose-400 transition-colors shadow-sm"
                  />
                </div>
              </div>
              ...
              {/* Photo Upload */}
              <div>
                <label className="block text-xs font-bold uppercase tracking-widest text-slate-500 mb-2">Upload Clear Photo (Headshot/Full Body)</label>
                <div className="relative group">
                  ...
                  />
                  <div className={`w-full border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center text-center transition-colors ${file ? 'border-amber-400 bg-amber-50' : 'border-slate-300 bg-slate-50 group-hover:border-rose-400 group-hover:bg-rose-50'}`}>
                    <UploadCloud className={`w-10 h-10 mb-3 ${file ? 'text-amber-500' : 'text-slate-400 group-hover:text-rose-500'} transition-colors`} />
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-rose-500 to-rose-700 text-white px-8 py-4 rounded-2xl font-bold tracking-widest uppercase text-xs shadow-[0_4px_15px_rgba(225,29,72,0.3)] hover:shadow-[0_6px_20px_rgba(225,29,72,0.4)] hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2 border border-rose-400/30 disabled:opacity-70 disabled:cursor-not-allowed"
                >
