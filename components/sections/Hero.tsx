  ...
  return (
    <section id="home" className="relative pt-32 pb-16 md:pt-40 md:pb-20 overflow-hidden flex items-center min-h-[85vh]">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10 w-full flex flex-col items-center text-center animate-in zoom-in-95 duration-1000">
        ...
        {/* Main Headline - Using the elegant, thinner Serif font you liked! */}
        <h1 className="font-serif text-4xl md:text-5xl lg:text-[3.5rem] font-semibold text-slate-900 tracking-tight leading-[1.1] mb-5 drop-shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
          {/* Hero CTA Button - Strictly locked to /register */}
          <Link 
            href="/register" 
